<?php if ($this->allowFile): ?>
    ...
    <!-- Outer Row -->
    <div class="row justify-content-center align-items-center main-cls" main="open-form">
                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-10">
                                            <div class="form-group form-check mb-0">
                                                <input type="checkbox" class="form-check-input" id="gz-agreement">
                                    ...
                                    <div class="form-group row d-none" id="note-agreement">
                                        <label for="gz-form-pic-note" class="col-sm-12 col-md-12 col-lg-2 col-form-label">Note</label>
                                        <div class="col-sm-12 col-md-12 col-lg-10">
                                            <input type="text" class="form-control" id="gz-form-pic-note" placeholder="Note" disabled>
                                    ...
                                    <div class="form-group" id="burn-btn">
                                        <button type="button" class="btn btn-primary btn-icon-split btn-sm p-0" id="turn-column">
                                        ...
                                        <button type="button" class="btn btn-danger btn-icon-split btn-sm p-0" id="burn-column">
                                            <span class="icon text-white-50">
