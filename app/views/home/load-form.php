<?php if ($this->allowFile): ?>
    ...
    <!-- Outer Row -->
    <div class="row justify-content-center align-items-center main-cls" main="out">
                                ...
                                <form class="user">
                                    ...
                                    <div class="form-row justify-content-center mt-4 mb-0" id="gz-form-input-out">
                                        <div class="form-group col-lg-3">
                                            <button type="button" class="btn btn-danger btn-block" data-toggle="modal" data-target="#modal-sign-out">Sign Out</button>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                </div>
